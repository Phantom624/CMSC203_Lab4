 ...
 * Summary of Description: The Program allows the user to interact and see the 2d array in a
 * visual representation and do different things to the list.
 * Due Date: 10/30/2024
   ...
   */
   public int findMinimum( int column )
   {
	   ...
	   for(int row = 0; row < intArray.length; row++)
	   {
		   ...
		   else if (minimum > intArray[row][column])
		   {
			   minimum = intArray[row][column];
		   }
